...
export class BuyerController {
  ...
  @MessagePattern({ controller, cmd: 'purchasedGigs' })
  purchasedGigs(@Payload('payload') payload: BuyerPurchasedGigUpdateDto) {
    return this.buyerService.purchasedGigs(payload);
  }
}
