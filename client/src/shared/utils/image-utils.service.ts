export function validateImage(file: File, type: string): boolean {
  if (type === 'image') {
...
export function checkImageSize(file: File, type: string): string {
  let fileError = '';
...
export function checkUrlExtension(fileExtension: string): string {
  let fileType = '';
